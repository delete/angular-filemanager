(function() {
    'use strict';
    angular.module('FileManagerApp').config(configTranslate);
    ...
    function configTranslate($translateProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            error_restore_files: 'An error occurred restoring files',
            error_downloading: 'An error occurred downloading files',
        ...
        $translateProvider.translations('pt', {
            ...
            error_restore_files: 'Ocorreu um erro ao restaurar os arquivos',
            error_downloading: 'Ocorreu um erro ao baixar os arquivos',
