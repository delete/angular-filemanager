(function() {
    ...
    apiHandler.$inject = ['$http', '$q', '$window', '$translate', 'Upload'];
        
    /* @ngInject */
    function apiHandler($http, $q, $window, $translate, Upload) {
        var $ = window.$;
        ...
        ApiHandler.prototype.restoreFromTrash = function(apiUrl, items) {
            var self = this;
            var deferred = $q.defer();
            var data = {
                action: 'restore',
        ...
        ApiHandler.prototype.downloadFromCloud = function(apiUrl, items) {
            var self = this;
            var deferred = $q.defer();
            var data = {
                action: 'download',
